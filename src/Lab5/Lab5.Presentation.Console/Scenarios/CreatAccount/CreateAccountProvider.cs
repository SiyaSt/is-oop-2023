...
public class CreateAccountProvider : IScenarioProvider
{
    ...
    public CreateAccountProvider(ICurrentService currentAdmin, IAdminAccountService adminAccountService)
    {
    ...
    public bool TryGetScenario([NotNullWhen(true)]out IScenario? scenario)
    {
        ...
        scenario = new CreateAccountScenario(_adminAccountService);
        return true;
    }
}